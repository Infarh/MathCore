...
namespace MathCore
{
    ...
    public abstract class ProducerConsumerCollectionBase<T> : IProducerConsumerCollection<T>
    {
        ...
        protected ProducerConsumerCollectionBase(IProducerConsumerCollection<T> contained) => _Contained = contained ?? throw new ArgumentNullException(nameof(contained));
