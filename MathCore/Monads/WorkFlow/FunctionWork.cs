...
namespace MathCore.Monads.WorkFlow
{
    ...
    public class FunctionWork<T> : Work<T>
    {
        ...
        internal FunctionWork([NotNull] Func<T> WorkFunction, [CanBeNull] Work BaseWork = null) : base(BaseWork) => _WorkFunction = WorkFunction ?? throw new ArgumentNullException(nameof(WorkFunction));
