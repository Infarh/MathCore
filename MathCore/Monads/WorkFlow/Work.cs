...
public class Work<TParameter, TResult> : Work<TResult>
{
    ...
    /// <param name="WorkFunction">Функция, преобразующая значение</param>
    /// <param name="BaseWork">Базовая работа, являющаяся источником аргумента функции</param>
    internal Work(Func<TParameter, TResult> WorkFunction, Work<TParameter> BaseWork) : this(WorkFunction, (Work)BaseWork) { }
...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    public new IWorkResult<TParameter, TResult> Execute() => (IWorkResult<TParameter, TResult>)base.Execute();
}
...
public abstract class Work<T> : Work
{
    ...
    private class FunctionWorkIfSuccess<TParameter, TResult> : Work<TParameter, TResult>
    {
        ...
        internal FunctionWorkIfSuccess(Func<TParameter, TResult> WorkFunction, Work<TParameter> BaseWork) : base(WorkFunction, BaseWork) { }
...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    public Work Invoke(Action<T> action) => new ActionWork<T>(action, this);
    ...
    public Work<T, TResult> Get<TResult>(Func<T, TResult> function) => new(function, this);
    ...
    public Work<T, TResult> GetIfSuccess<TResult>(Func<T, TResult> function) => new FunctionWorkIfSuccess<T, TResult>(function, this);
    ...
    public Work<T> GetIfFailure(Func<Exception, T> ErrorHandler) => new ExceptionFunctionHandler<T>(ErrorHandler, this);
    ...
    public static implicit operator T(Work<T> work) => work.Execute().Result;
}
...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    protected class ExceptionFunctionHandler<T> : Work<T>
    {
        ...
        private readonly Func<Exception, T> _ErrorHandler;
...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    public static ActionWork BeginInvoke(Action WorkAction) => new(WorkAction);
    ...
    public static FunctionWork<T> BeginGet<T>(Func<T> WorkFunction) => new(WorkFunction);
    ...
    public static Work<T> With<T>(T value) => new ConstValueWork<T>(value);
    ...
    protected abstract IWorkResult Execute(IWorkResult? BaseResult);
    ...
    public Work Invoke(Action action) => new ActionWork(action, this);
    ...
    public Work InvokeIfSuccess(Action action) => new ActionWorkIfSuccess(action, this);
    ...
    public Work InvokeIfFailure(Action action) => new ActionWorkIfFailure(action, this);
    ...
    /// <returns>Сформированная работа, выполняемая в случае неудачи предыдущего действия</returns>
    public Work InvokeIfFailure(Action<Exception> ErrorHandler) => new ExceptionActionHandler(ErrorHandler, this);
    ...
    public Work<T> Get<T>(Func<T> function) => new FunctionWork<T>(function, this);
    ...
    public Work<T> GetIfSuccess<T>(Func<T> function) => new FunctionWorkIfSuccess<T>(function, this);
    ...
    public Work<T> GetIfFailure<T>(Func<T> function) => new FunctionWorkIfFailure<T>(function, this);
}