...
public class UnaryOperatorEvaluation<TObject, TValue> : ConvertEvaluation<TObject, TValue>
{
    ...
    public UnaryOperatorEvaluation(Func<Ex, Ex> Operator, Evaluation<TObject> value)
        : base(value, GetOperation(Operator)) => _Operator = Operator;

    /// <inheritdoc />
    public override Ex GetExpression() => _Operator(InputEvaluation.GetExpression());
}