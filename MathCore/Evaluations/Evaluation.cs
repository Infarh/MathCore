...
namespace MathCore.Evaluations
{
    ...
    public abstract class Evaluation<T> : Evaluation
    {
        ...
        public static AdditionEvaluation<T> operator +(Evaluation<T> x, Evaluation<T> y) => new AdditionEvaluation<T>(x, y);
        ...
        public static SubtractEvaluation<T> operator -(Evaluation<T> x, Evaluation<T> y) => new SubtractEvaluation<T>(x, y);
        ...
        public static NegateOperatorEvaluation<T> operator -(Evaluation<T> x) => new NegateOperatorEvaluation<T>(x);
        ...
        public static MultiplyEvaluation<T> operator *(Evaluation<T> x, Evaluation<T> y) => new MultiplyEvaluation<T>(x, y);
        ...
        public static DivideEvaluation<T> operator /(Evaluation<T> x, Evaluation<T> y) => new DivideEvaluation<T>(x, y);
    }
}