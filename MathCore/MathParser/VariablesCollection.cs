...
namespace MathCore.MathParser
{
    ...
    public class VariablesCollection : IEnumerable<ExpressionVariable>
    {
        ...
        public VariablesCollection([NotNull] MathExpression expression) => _Expression = expression;
        ...
        public bool Add([NotNull] ExpressionVariable Variable)
        {
        ...
        public bool Replace([NotNull] string Name, [NotNull] ExpressionVariable variable)
        {
            var replaced = false;
            var old_var = _Variables.Find(v => v.Name == Name);
        ...
        /// <param name="Variable">Перемещаемая переменная</param>
        /// <returns>Истина, если переменная была перемещена из коллекции переменных в коллекцию констант</returns>
        public bool MoveToConstCollection([NotNull] ExpressionVariable Variable) =>
        ...
        public bool RemoveFromCollection([NotNull] ExpressionVariable Variable) => _Variables.Remove(Variable);
        ...
        public bool Exist([NotNull] ExpressionVariable variable) => _Variables.Contains(variable);
        ...
        public bool Exist([NotNull] Predicate<ExpressionVariable> exist) => _Variables.Exists(exist);
