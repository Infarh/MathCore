...
/// </remarks>
[Serializable]
public class ExpressionMatrix : ICloneable<ExpressionMatrix>, IEquatable<ExpressionMatrix>, IIndexable<int, int, Expression>
{
    /* -------------------------------------------------------------------------------------------- */
    ...
    [DST]
    public static ExpressionMatrix operator +(ExpressionMatrix M, Expression x) => new(M.N, M.M, (i, j) => M[i, j].AddWithConversion(x));

    [DST]
    public static ExpressionMatrix operator +(Expression x, ExpressionMatrix M) => new(M.N, M.M, (i, j) => x.AddWithConversion(M[i, j]));

    [DST]
    public static ExpressionMatrix operator -(ExpressionMatrix M, Expression x) => new(M.N, M.M, (i, j) => M[i, j].Subtract(x));

    [DST]
    public static ExpressionMatrix operator -(Expression x, ExpressionMatrix M) => new(M.N, M.M, (i, j) => x.Subtract(M[i, j]));

    [DST]
    public static ExpressionMatrix operator *(ExpressionMatrix M, Expression x) => new(M.N, M.M, (i, j) => M[i, j].MultiplyWithConversion(x));

    [DST]
    public static ExpressionMatrix operator *(Expression x, ExpressionMatrix M) => new(M.N, M.M, (i, j) => x.MultiplyWithConversion(M[i, j]));

    [DST] public static ExpressionMatrix operator *(Expression[,] A, ExpressionMatrix B) => (ExpressionMatrix)A * B;

    [DST] public static ExpressionMatrix operator *(Expression[] A, ExpressionMatrix B) => (ExpressionMatrix)A * B;

    [DST] public static ExpressionMatrix operator *(ExpressionMatrix A, Expression[] B) => A * (ExpressionMatrix)B;

    [DST] public static ExpressionMatrix operator *(ExpressionMatrix A, Expression[,] B) => A * (ExpressionMatrix)B;

    [DST]
    public static ExpressionMatrix operator /(ExpressionMatrix M, Expression x) => new(M.N, M.M, (i, j) => M[i, j].Divide(x));
    ...
    [DST]
    public static explicit operator Expression[,](ExpressionMatrix M) => (Expression[,])M._Data.Clone();

    [DST]
    public static explicit operator ExpressionMatrix(Expression[,] Data) => new(Data);
