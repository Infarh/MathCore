...
namespace MathCore.Expressions.Complex
{
    public abstract class ComplexExpression
    {
        ...
        protected static ConstantExpression Constant(object value) => Expression.Constant((double)value);
        protected static UnaryExpression Negate(Expression value) => Expression.Negate(value);
        protected static BinaryExpression Add(Expression Left, Expression Right) => Expression.Add(Left, Right);
        protected static BinaryExpression Subtract(Expression Left, Expression Right) => Expression.Subtract(Left, Right);
        protected static BinaryExpression Multiply(Expression Left, Expression Right) => Expression.Multiply(Left, Right);
        protected static BinaryExpression Divide(Expression Left, Expression Right) => Expression.Divide(Left, Right);
        protected static BinaryExpression Divide(Expression Left, double Right) => Expression.Divide(Left, Constant(Right));
        protected static BinaryExpression GetPower(Expression Left, Expression Right) => Expression.Power(Left, Right);
        protected static BinaryExpression GetPower(double Left, Expression Right) => Expression.Power(Constant(Left), Right);
        protected static BinaryExpression GetPower(Expression Left, double Right) => Expression.Power(Left, Constant(Right));
        protected static Expression Inverse(Expression value) => Divide(Constant(1d), value);

        protected static Expression GetAbs(Expression value) => Expression.Call(((Func<double, double>)Math.Abs).Method, value);
        protected static Expression GetSqrt(Expression value) => Expression.Call(((Func<double, double>)Math.Sqrt).Method, value);
        protected static Expression GetAtan2(Expression y, Expression x) => Expression.Call(((Func<double, double, double>)Math.Atan2).Method, y, x);
        protected static Expression GetSin(Expression value) => Expression.Call(((Func<double, double>)Math.Sin).Method, value);
        protected static Expression GetCos(Expression value) => Expression.Call(((Func<double, double>)Math.Cos).Method, value);
        protected static Expression GetLog(Expression value) => Expression.Call(((Func<double, double>)Math.Log).Method, value);
        ...
        public static CopmlexConstantExpression Exp(Expression Abs, Expression Arg) => new CopmlexConstantExpression(Multiply(Abs, GetCos(Arg)), Multiply(Abs, GetSin(Arg)));

        public static CopmlexConstantExpression Exp(double Arg) => Exp(Constant(Arg));

        public static CopmlexConstantExpression Exp(Expression Arg) => new CopmlexConstantExpression(GetCos(Arg), GetSin(Arg));
