...
public readonly struct Basis3D : IEquatable<Basis3D>
{
    ...
    public static Basis3D Scale(double kx, double ky, double kz) => new(
        kx, 0, 0,
        0, ky, 0,
        0, 0, kz);
    ...
    public static Basis3D RotateOX(double Angle, bool Positive = true) => new(
        1, 0, 0,
    ...
    public static Basis3D RotateOY(double Angle, bool Positive = true) => new(
    ...
    public static Basis3D RotateOZ(double Angle, bool Positive = true) => new(
    ...
    {
        var (sin_a, cos_a) = Complex.SinCos(alpha);
        var (sin_b, cos_b) = Complex.SinCos(beta);
        var (sin_g, cos_g) = Complex.SinCos(gamma);
    ...
    {
        var (sin_t, cos_t) = Complex.SinCos(theta);
        var cos_t1         = 1 - cos_t;
        var (x, y, z)      = v;
...
#pragma warning restore IDE1006 // Стили именования
    ...
    public static explicit operator Basis3D(Matrix M) => new(
        M[0, 0], M[0, 1], M[0, 2],
        M[1, 0], M[1, 1], M[1, 2],
        M[2, 0], M[2, 1], M[2, 2]);
