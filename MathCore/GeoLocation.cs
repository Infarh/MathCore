...
public readonly struct GeoLocation
{
    ...
    public GeoLocation(double Latitude, double Longitude) => (this.Latitude, this.Longitude) = (Latitude, Longitude);
    ...
    public GeoLocation(Point Point) => (Latitude, Longitude) = (Point.Y, Point.X);

    /// <summary>Инициализация нового географического положения из точки</summary>
    /// <param name="Point">Точка положения</param>
    public GeoLocation(PointF Point) => (Latitude, Longitude) = (Point.Y, Point.X);
