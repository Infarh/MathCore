...
namespace MathCore.ViewModels
{
    ...
    public partial class ViewModel : INotifyPropertyChanging, INotifyPropertyChanged, IDisposable
    {
        ...
        protected void PropertyDependence_Add([NotNull] string PropertyName, [NotNull] params string[] Dependencies)
        {
        ...
        private Queue<string> IsLoopDependency(in string property, in string dependency, in string next_property = null, Stack<string> invoke_stack = null)
        {
            ...
            {
                var invoke_queue = IsLoopDependency(property, dependency, dependence_property, invoke_stack.AddValue(check_property));
