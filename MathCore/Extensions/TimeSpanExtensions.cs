...
{
    /// <summary>Преобразует объект <see cref="TimeSpan"/> в строку короткого формата</summary>
    /// <param name="time">Временной интервал</param>
    /// <returns>Строка короткого формата, представляющая временной интервал</returns>
    [DST]
