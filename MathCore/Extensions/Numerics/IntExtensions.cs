...
{
    /// <summary>Реверсирует биты в 32-битном целочисленном значении</summary>
    /// <param name="b">Целочисленное значение, биты которого нужно реверсировать.</param>
    /// <returns>Целочисленное значение с реверсированными битами.</returns>
    public static int ReverseBits(this int b) => (int)((uint)b).ReverseBits();

    /// <summary>Реверсирует биты в 32-битном беззнаковом целочисленном значении</summary>
    /// <param name="b">Беззнаковое целочисленное значение, биты которого нужно реверсировать.</param>
    /// <returns>Беззнаковое целочисленное значение с реверсированными битами.</returns>
