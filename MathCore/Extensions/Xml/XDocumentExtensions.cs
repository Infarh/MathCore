...
public static class XDocumentExtensions
{
    ...
    public static void XPathSetValue(this XContainer xml, string path, object Value)
    {
        ...
        if (xml is not XDocument { Root: { } root })
            throw new InvalidOperationException("В документе отсутствует корневой элемент");

        switch (((IEnumerable<object>)root.XPathEvaluate(path)).FirstOrDefault())
        {
    ...
    public static string? XPathString(this XContainer xml, string path) =>
        path is not { Length: > 0 }
            ? throw new ArgumentException("Не задан путь")
            : xml is not XDocument { Root: { } root }
                ? throw new InvalidOperationException("В документе отсутствует корневой элемент")
    ...
    public static int? XPathInt32(this XContainer xml, string path) =>
        path is not { Length: > 0 }
            ? throw new ArgumentException("Не задан путь")
            : xml is not XDocument { Root: { } root }
                ? throw new InvalidOperationException("В документе отсутствует корневой элемент")
    ...
    public static double? XPathDouble(this XContainer xml, string path) =>
        path is not { Length: > 0 }
            ? throw new ArgumentException("Не задан путь")
            : xml is not XDocument { Root: { } root }
                ? throw new InvalidOperationException("В документе отсутствует корневой элемент")
    ...
    public static DateTime? XPathDateTime(this XContainer xml, string path) =>
        path is not { Length: > 0 }
            ? throw new ArgumentException("Не задан путь")
            : xml is not XDocument { Root: { } root }
                ? throw new InvalidOperationException("В документе отсутствует корневой элемент")
    ...
    public static bool? XPathBool(this XContainer xml, string path) =>
        path is not { Length: > 0 }
            ? throw new ArgumentException("Не задан путь")
            : xml is not XDocument { Root: { } root }
                ? throw new InvalidOperationException("В документе отсутствует корневой элемент")
