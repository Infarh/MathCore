...
namespace System
{
    ...
    public static class BoolExtensions
    {
        ...
        public static bool And([NotNull] this IEnumerable<bool> items)
        {
            switch (items)
            {
                case null:
        ...
        public static bool AndLazy([NotNull] this IEnumerable<bool> items)
        {
            switch (items)
            {
                case null:
        ...
        public static bool Or([NotNull] this IEnumerable<bool> items)
        {
            switch (items)
            {
                case null:
        ...
        public static bool OrLazy([NotNull] this IEnumerable<bool> items)
        {
            switch (items)
            {
                case null:
