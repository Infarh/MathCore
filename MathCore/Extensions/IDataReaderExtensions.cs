...
namespace System.Data
{
    ...
    public static class IDataReaderExtensions
    {
        ...
        [NotNull]
        public static List<T> ReadToEnd<T>([NotNull] this IDataReader Reader, Func<IDataRecord, T> Read)
        {
        ...
        public static IEnumerable<T> AsEnumerable<T>([NotNull] this IDataReader Reader, Func<IDataRecord, T> Read)
        {
