...
namespace System
{
    ...
    public static class FuncExtensions
    {
        ...
        public static FunctionEvaluation<T> ToEvaluation<T>(this Func<T> function, [CanBeNull] string Name = null) =>
        ...
        /// <returns>Значение аргумента нуля функции</returns>
        /// <exception cref="Exception">A delegate callback throws an exception.</exception>
        public static Task<double> GetRoot_TernarySearchAsync(this Function f, double x1, double x2, double Eps = 0.0001) => Task.Factory.StartNew(() => f.GetRoot_TernarySearch(x1, x2, Eps));
        ...
        public static Function Add(this Function f, double a) => a.Equals(0) ? f : x => f(x) + a;
        ...
        public static Function ArgumentShift(this Function f, double x0) => x0.Equals(0) ? f : x => f(x - x0);
        ...
        public static Function ArgumentCompression(this Function f, double k, double b = 0d) =>
        ...
        /// </returns>
        public static Function Divide(this Function f, double a) =>
            a.Equals(1)
                ? f
                : (a.Equals(0)
        ...
        public static Function Multiply(this Function f, double a) => a.Equals(1d) ? f : x => f(x) * a;
        ...
        public static Function Subtract(this Function f, double a) => a.Equals(0d) ? f : x => f(x) - a;
