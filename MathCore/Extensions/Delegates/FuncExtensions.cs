...
public static class FuncExtensions
{
    ...
    public static Task<TResult> InvokeAsync<TResult>(this Func<TResult> func) => Task.Run(func);
    ...
    /// <typeparam name="TResult">Тип значения функции</typeparam>
    /// <returns>Задача асинхронного вычисления значения функции</returns>
    public static Task<TResult> InvokeAsync<TValue, TResult>(this Func<TValue, TResult> func, TValue value) => Task.Run(() => func(value));
    ...
    /// <returns>Значение аргумента нуля функции</returns>
    /// <exception cref="Exception">A delegate callback throws an exception.</exception>
    public static double GetRoot_GoldenSection(this Function f, double x1, double x2, double Eps = 1e-5)
    {
    ...
    /// <returns>Значение аргумента нуля функции</returns>
    /// <exception cref="Exception">A delegate callback throws an exception.</exception>
    public static Task<double> GetRoot_GoldenSectionAsync(this Function f, double x1, double x2, double Eps = 1e-5) => Task.Run(() => f.GetRoot_GoldenSection(x1, x2, Eps));
    ...
    /// <returns>Значение аргумента нуля функции</returns>
    /// <exception cref="Exception">A delegate callback throws an exception.</exception>
    public static double GetRoot_TernarySearch(this Function f, double x1, double x2, double Eps = 0.0001)
    {
        while (Math.Abs(x2 - x1) > Eps)
        {
            var d                 = (x2 - x1) / 3;
    ...
    /// <returns>Значение аргумента нуля функции</returns>
    /// <exception cref="Exception">A delegate callback throws an exception.</exception>
    public static Task<double> GetRoot_TernarySearchAsync(this Function f, double x1, double x2, double Eps = 0.0001) => Task.Run(() => f.GetRoot_TernarySearch(x1, x2, Eps));
    ...
    /// <returns>Значение аргумента нуля функции</returns>
    /// <exception cref="Exception">A delegate callback throws an exception.</exception>
    public static double GetRoot_MethodOfChords(this Function f, double x1, double x2, double Eps = 0.0001)
    {
        while (Math.Abs(x2 - x1) > Eps)
        {
            var f1 = f(x1);
    ...
    /// <returns>Значение аргумента нуля функции</returns>
    /// <exception cref="Exception">A delegate callback throws an exception.</exception>
    public static Task<double> GetRoot_MethodOfChordsAsync(this Function f, double x1, double x2, double Eps = 0.0001) =>
    ...
    public static Func<TArg2, Func<TArg1, TResult>> Carrying<TArg1, TArg2, TResult>(this Func<TArg1, TArg2, TResult> f) =>
        y => x => f(x, y);
    ...
    public static Function Add(this Function f, double a) => a == 0 ? f : x => f(x) + a;
    ...
    public static Function Add(this Function f1, Function f2) => x => f1(x) + f2(x);
    ...
    public static Function ArgumentReverse(this Function f) => x => f(-x);
    ...
    public static Function ArgumentShift(this Function f, double x0) => x0 == 0 ? f : x => f(x - x0);
    ...
    public static Function ArgumentCompression(this Function f, double k, double b = 0d) => (k, b) switch
    {
        (0, 0) => _ => 0,
        (1, 0) => f,
    ...
    /// </returns>
    public static Function Divide(this Function f, double a) => a switch
    {
        1 => f,
        0 => x => x switch
        {
    ...
    public static Function Divide(this Function f1, Function f2) => x => f1(x) / f2(x);
    ...
    public static Function Func(this Function f, Function q) => x => q(f(x));
    ...
    (
        this Func<TIn, TOut> f,
        Func<Func<TIn, TOut>, Func<TIn, TOut>> q
    ) => q(f);
    ...
    public static Function FuncFor(this Function f, Function q) => x => f(q(x));
    ...
    public static Function GetDifferential(this Function f, double dx = 0.0001, int n = 0) =>
    ...
    public static double GetDifferentialValue(this Function f, double x, double dx = 0.0001, int n = 0)
    {
        if (n == 0)
        {
            var Dx    = dx / 2d;
    ...
    (
        ...
        ? Task.FromResult(f0)
        : Task.Run(() => f.GetIntegralValue(x1, x2, f0, dx));
    ...
    (
        this Function f,
        Func<double, double, double> Core,
        double x1,
        double x2,
        double f0 = 0,
        double dx = 0.0001
    ...
    (
        ...
        ? Task.FromResult(f0)
        : Task.Run(() => f.GetIntegralValue(Core, x1, x2, dx));
    ...
    /// <param name="N">Число интервалов интегрирования N > 2</param>
    /// <returns>Интеграл функции на отрезке методом Симпсона</returns>
    public static Task<double> GetIntegralValue_SimpsonAsync(this Function f, double x1, double x2, int N = 100) =>
        x1 == x2
            ? Task.FromResult(0d)
            : Task.Run(() => f.GetIntegralValue_Simpson(x1, x2, N));
    ...
    /// </remarks>
    public static double GetIntegralValue_Adaptive(this Function f, double x1, double x2, int N = 2, double Eps = 1e-6)
    {
        if (x1 == x2) return 0;
    ...
    /// <param name="N">Разбиение интервала интегрирования</param>
    /// <returns>Значение интеграла функции</returns>
    public static Task<double> GetIntegralValue_SplineAsync(this Function f, double x1, double x2, int N = 1000) =>
        x1 == x2
            ? Task.FromResult(0d)
            : Task.Run(() => f.GetIntegralValue_Spline(x1, x2, N));
    ...
    {
        if (x0 != 0.0) f = f.ArgumentShift(x0);
    ...
    public static T[] Sampling<T>(this Func<double, T> f, double x1, double dx, int SamplesCount)
    {
        ...
        if (dx == 0d) throw new ArgumentOutOfRangeException(nameof(dx), "Шаг дискретизации не должен быть равен 0");
    ...
    public static TResult[] GetValues<TArgument, TResult>(this Func<TArgument, TResult> f, params TArgument[] args) =>
        args.Function(f);
    ...
    public static Function Inverse(this Function f) => x => 1 / f(x);
    ...
    public static Function Multiply(this Function f1, Function f2) => x => f1(x) * f2(x);
    ...
    public static Function Multiply(this Function f, double a) => a == 1d ? f : x => f(x) * a;
    ...
    public static Function Reverse(this Function f) => x => -f(x);
    ...
    public static Function Subtract(this Function f1, Function f2) => x => f1(x) - f2(x);
    ...
    public static Function Subtract(this Function f, double a) => a == 0d ? f : x => f(x) - a;
    ...
    public class SimpleSamplingResult : SamplingResult<double>
    {
        ...
        private readonly Function _F = null!;
        ...
        /// <param name="dx">Шаг дискретизации</param>
        public SimpleSamplingResult(Function f, double x1, double x2, double dx)
    ...
    public static SimpleSamplingResult SamplingAdaptive(this Function f, double x1, double x2, double Eps)
    ...
    private sealed class SamplingResultHalfDivision : SamplingResult<double>
    {
        ...
        /// <param name="x2">Конец интервала дискретизации</param>
        /// <param name="Eps">Требуемая точность</param>
        public SamplingResultHalfDivision(Function f, double x1, double x2, double Eps)
