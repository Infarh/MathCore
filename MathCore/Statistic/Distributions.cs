...
namespace MathCore.Statistic
{
    public static partial class Distributions
    {
        ...
        public static Func<double, double> Hi2(int n) { return Gamma(n / 2d, 2); }

        public static double Hi2(int n, double x) { return Gamma(n / 2d, 2, x); }
        ...
        public static Func<double, double> Uniform(double a, double b) { return x => x >= a && x <= b ? 1 / (b - a) : 0; }

        public static double Uniform(double x, double a, double b) { return x >= a && x <= b ? 1 / (b - a) : 0; }

        public static Func<double, double> Triangular(double a, double b) { return x => Triangular(x, a, b); }

        public static double Triangular(double x, double a, double b)
        {
            return x >= a && x <= b ? 2 / (b - a) - 2 / ((b - a) * (b - a)) * Math.Abs(a + b - 2 * x) : 0;
        }

        public static Func<double, double> Rayleigh(double sigma) { return x => Rayleigh(x, sigma); }
