...
namespace MathCore.Trees
{
    ...
    public static class ITreeItemEx
    {
        ...
        [NotNull]
        public static T GetRootItem<T>(this T Item) where T : class, ITreeItem<T> => Item.EnumerateParents().Last();
        ...
        public static T[] GetParents<T>(this T Item) where T : class, ITreeItem<T> =>
            Item is null
                ...
                : Item.Parent is null
                    ? Array.Empty<T>()
                    : new Stack<T>(Item.EnumerateParents()).ToArray();

        public static IEnumerable<T> EnumerateParents<T>(this T item) where T : class, ITreeItem<T>
        {
