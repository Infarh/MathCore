...
namespace MathCore
{
    ...
    public class MatrixInt : ICloneable, IEquatable<MatrixInt>, IIndexable<int, int, int>
    {
        ...
        public int this[int i, int j] { [DST] get { return _Data[i, j]; } [DST] set { _Data[i, j] = value; } }
        ...
        [DST]
        public static implicit operator MatrixInt(int X) { return new MatrixInt(1, 1) { [0, 0] = X }; }

        [DST]
        public static explicit operator int[,](MatrixInt M) { return (int[,])M._Data.Clone(); }

        [DST]
        public static explicit operator MatrixInt(int[,] Data) { return new MatrixInt(Data); }
        ...
        [DST]
        bool IEquatable<MatrixInt>.Equals(MatrixInt other) { return Equals(other); }
