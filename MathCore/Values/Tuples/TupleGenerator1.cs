...
//        {
//            var t = new Tuple<T1>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 1 elements.", nameof(pList));
...
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 2 elements.", nameof(pList));
//            t.Element1 = (T1)e.Current;
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 2 elements.", nameof(pList));
...
//        {
//            var t = new Tuple<T1, T2, T3>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 3 elements.", nameof(pList));
//            t.Element1 = (T1)e.Current;
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 3 elements.", nameof(pList));
//            t.Element2 = (T2)e.Current;
...
//        {
//            var t = new Tuple<T1, T2, T3, T4>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 4 elements.", nameof(pList));
//            t.Element1 = (T1)e.Current;
//            if(!e.MoveNext())
//                throw new ArgumentException("Enumerable is too short. Needs to have at least 4 elements.", nameof(pList));
//            t.Element2 = (T2)e.Current;
...
//        {
//            var t = new Tuple<T1, T2, T3, T4, T5>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
...
//        {
//            var t = new Tuple<T1, T2, T3, T4, T5, T6>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
...
//        {
//            var t = new Tuple<T1, T2, T3, T4, T5, T6, T7>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
...
//        {
//            var t = new Tuple<T1, T2, T3, T4, T5, T6, T7, T8>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
...
//        {
//            var t = new Tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
...
//        {
//            var t = new Tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>();
//            var e = pList.GetEnumerator();
//            if(!e.MoveNext())
...
//    /// </summary>
//    public Tuple <T2> Tail => Tuple.New(
//                                        Element2
//                );
//}
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3> Tail => Tuple.New(
//                                            Element2
//                                            ,Element3
//                );
//}
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4> Tail => Tuple.New(
//                                                Element2
//                                                ,Element3
//                                                ,Element4
//                );
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4, T5> Tail => Tuple.New(
//                                                    Element2
//                                                    ,Element3
//                                                    ,Element4
//                                                    ,Element5
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4, T5, T6> Tail => Tuple.New(
//                                                        Element2
//                                                        ,Element3
//                                                        ,Element4
//                                                        ,Element5
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4, T5, T6, T7> Tail => Tuple.New(
//                                                            Element2
//                                                            ,Element3
//                                                            ,Element4
//                                                            ,Element5
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4, T5, T6, T7, T8> Tail => Tuple.New(
//                                                                Element2
//                                                                ,Element3
//                                                                ,Element4
//                                                                ,Element5
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4, T5, T6, T7, T8, T9> Tail => Tuple.New(
//                                                                    Element2
//                                                                    ,Element3
//                                                                    ,Element4
//                                                                    ,Element5
...
//    /// not change the original tuple.
//    /// </summary>
//    public Tuple <T2, T3, T4, T5, T6, T7, T8, T9, T10> Tail => Tuple.New(
//                                                                         Element2
//                                                                         ,Element3
//                                                                         ,Element4
//                                                                         ,Element5
