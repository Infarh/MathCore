...
public class DictionaryReadOnly<TKey, TValue>(IDictionary<TKey, TValue> dictionary) : IDictionary<TKey, TValue>
{
    ...
    /// <summary>Получает или задает элемент с указанным ключом</summary>
    ...
    /// <summary>Получает интерфейс <see cref="T:System.Collections.Generic.ICollection`1"/>, содержащий значения <see cref="T:System.Collections.Generic.IDictionary`2"/></summary>
    /// <returns>
