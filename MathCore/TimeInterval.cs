...
public readonly struct DateTimeInterval
{
    ...
    /// <summary>Включена ли нижняя граница интервала?</summary>
    private readonly bool _MinInclude = true;
    /// <summary>Включена ли верхняя граница интервала?</summary>
    private readonly bool _MaxInclude = true;
    /// <summary>Нижняя граница интервала</summary>
    ...
    /// <summary>Нижняя граница интервала</summary>
    public DateTime Min { get => _Min; init => _Min = value; }

    /// <summary>Верхняя граница интервала</summary>
    public DateTime Max { get => _Max; init => _Max = value; }

    /// <summary>Протяжённость интервала</summary>
    public DateTime Length => new(_Max.Ticks - _Min.Ticks);
    //{
    ...
    public DateTime Middle => new((_Min.Ticks + _Max.Ticks) / 2);
    //{
