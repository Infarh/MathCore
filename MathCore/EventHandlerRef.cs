...
public delegate void EventHandlerRef<TEventArgs>(object Sender, in TEventArgs e = default) 
    where TEventArgs : struct;

public delegate void EventHandlerRef<T1, T2>(object Sender, in EventArgsRef<T1, T2> e = default);

public readonly ref struct EventArgsRef<T1, T2>
{
    public T1 Arg1 { get; init; }

    public T2 Arg2 { get; init; }

    public EventArgsRef(T1 Arg1, T2 Arg2)
    {
        this.Arg1 = Arg1;
        this.Arg2 = Arg2;
    }
...
public readonly ref struct EventArgsRef<T1, T2, T3>
{
    public T1 Arg1 { get; init; }
    public T2 Arg2 { get; init; }
    public T3 Arg3 { get; init; }

    public EventArgsRef(T1 Arg1, T2 Arg2, T3 Arg3)
    {
        this.Arg1 = Arg1;
        this.Arg2 = Arg2;
        this.Arg3 = Arg3;
...
public readonly ref struct EventArgsRef<T1, T2, T3, T4>
{
    public T1 Arg1 { get; init; }
    public T2 Arg2 { get; init; }
    public T3 Arg3 { get; init; }
    ...
    public EventArgsRef(T1 Arg1, T2 Arg2, T3 Arg3, T4 Arg4)
    {
        this.Arg1 = Arg1;
        this.Arg2 = Arg2;
        this.Arg3 = Arg3;
