...
public class QueryOptions
{
    ...
    private static MethodInfo GetMethodInfo(Type ItemsType, Type SortingKeyType, bool IsDescending) =>
    ...
    private static readonly ConcurrentDictionary<(Type Source, Type Result, bool Descending), Delegate> __Selectors = new();
