                              ...
                              IEquatable<Matrix>, IEquatable<double[,]>
{
    ...
    public static Matrix Diagonal(params double[] elements) => new(Array.CreateDiagonal(elements));
    ...
    [DST]
    public Matrix((int N, int M) Shape, params IEnumerable<double> values)
    {
        var (N, M) = Shape;
    ...
    /// <summary>Возвращает представление текущей матрицы.</summary>
    /// <returns>Представление текущей матрицы.</returns>
