...
public class MD5
{
    ...
    private static void Compute(uint[] buffer16, ref uint a0, ref uint b0, ref uint c0, ref uint d0)
    {
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0xd76aa478 + buffer16[0], 7), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0xe8c7b756 + buffer16[1], 12), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0x242070db + buffer16[2], 17), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0xc1bdceee + buffer16[3], 22), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0xf57c0faf + buffer16[4], 7), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0x4787c62a + buffer16[5], 12), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0xa8304613 + buffer16[6], 17), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0xfd469501 + buffer16[7], 22), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0x698098d8 + buffer16[8], 7), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0x8b44f7af + buffer16[9], 12), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + ((B & C) | (~B & D)) + 0x6b901122 + buffer16[12], 7), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0xf61e2562 + buffer16[(5 * 16 + 1) % 16], 5), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0xc040b340 + buffer16[(5 * 17 + 1) % 16], 9), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0xd62f105d + buffer16[(5 * 20 + 1) % 16], 5), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0x02441453 + buffer16[(5 * 21 + 1) % 16], 9), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0x21e1cde6 + buffer16[(5 * 24 + 1) % 16], 5), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0xc33707d6 + buffer16[(5 * 25 + 1) % 16], 9), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0xa9e3e905 + buffer16[(5 * 28 + 1) % 16], 5), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + ((D & B) | (~D & C)) + 0xfcefa3f8 + buffer16[(5 * 29 + 1) % 16], 9), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + (B ^ C ^ D) + 0xfffa3942 + buffer16[(3 * 32 + 5) % 16], 4), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + (B ^ C ^ D) + 0xa4beea44 + buffer16[(3 * 36 + 5) % 16], 4), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + (B ^ C ^ D) + 0x289b7ec6 + buffer16[(3 * 40 + 5) % 16], 4), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + (B ^ C ^ D) + 0xd9d4d039 + buffer16[(3 * 44 + 5) % 16], 4), B, C);
        ...
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[48] + buffer16[7 * 48 % 16], 6), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[49] + buffer16[7 * 49 % 16], 10), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[50] + buffer16[7 * 50 % 16], 15), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[51] + buffer16[7 * 51 % 16], 21), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[52] + buffer16[7 * 52 % 16], 6), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[53] + buffer16[7 * 53 % 16], 10), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[54] + buffer16[7 * 54 % 16], 15), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[55] + buffer16[7 * 55 % 16], 21), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[56] + buffer16[7 * 56 % 16], 6), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[57] + buffer16[7 * 57 % 16], 10), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[58] + buffer16[7 * 58 % 16], 15), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[59] + buffer16[7 * 59 % 16], 21), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[60] + buffer16[7 * 60 % 16], 6), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[61] + buffer16[7 * 61 % 16], 10), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[62] + buffer16[7 * 62 % 16], 15), B, C);
        (A, B, C, D) = (D, B + LeftRotate(A + (C ^ (B | ~D)) + __K[63] + buffer16[7 * 63 % 16], 21), B, C);
