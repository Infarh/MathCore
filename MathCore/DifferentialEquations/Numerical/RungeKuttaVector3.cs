...
{
    public class RungeKuttaVector3
    {
        private static Vector3D[] GetKY(Vector3D[] YY, IReadOnlyList<Vector3D> Y, Vector3D[] k, double dt, int Count)
        {
        ...
        public static Vector3D Step4(
            Func<double, Vector3D, Vector3D> f,
            double t, double dt, Vector3D y)
        {
            var dt2 = dt / 2;
            var k1 = f(t, y);
        ...
        public static (double[] T, Vector3D[] Y) Solve4(
            Func<double, Vector3D, Vector3D> f,
            double dt,
            double Tmax,
            Vector3D y0 = default,
        ...
        public static (Vector3D y1, Vector3D y2) Step4(
            Func<double, (Vector3D y1, Vector3D y2), (Vector3D y1, Vector3D y2)> f,
            double t,
            double dt,
            (Vector3D y1, Vector3D y2) y)
        {
            var dt2 = dt / 2;
            var (y1, y2) = y;
        ...
        public static (double[] T, (Vector3D y1, Vector3D y2)[] Y) Solve4(
            Func<double, (Vector3D y1, Vector3D y2), (Vector3D y1, Vector3D y2)> f,
            double dt,
            double Tmax,
        ...
        public static (Vector3D y1, Vector3D y2, Vector3D y3) Step4(
            Func<double, (Vector3D y1, Vector3D y2, Vector3D y3), (Vector3D y1, Vector3D y2, Vector3D y3)> f,
            double t,
            double dt,
            (Vector3D y1, Vector3D y2, Vector3D y3) y)
        {
            var dt2 = dt / 2;
            var (y1, y2, y3) = y;
        ...
        public static (double[] T, (Vector3D y1, Vector3D y2, Vector3D y3)[] Y) Solve4(
            Func<double, (Vector3D y1, Vector3D y2, Vector3D y3), (Vector3D y1, Vector3D y2, Vector3D y3)> f,
            double dt,
            double Tmax,
        ...
        public static Vector3D[] Step4(
            Func<double, IReadOnlyList<Vector3D>, Vector3D[]> f,
            double t, double dt, IReadOnlyList<Vector3D> y)
        {
            var m = y.Count;
            var dt2 = dt / 2;
            var yt = new Vector3D[m];
        ...
        public static (Vector3D y, Vector3D err) Step45(
            Func<double, Vector3D, Vector3D> f,
            double t, double dt, Vector3D y)
        {
            var k1 = f(t, y);
        ...
        public static ((Vector3D y1, Vector3D y2) y, (Vector3D e1, Vector3D e2) err) Step45(
            Func<double, (Vector3D y1, Vector3D y2), (Vector3D y1, Vector3D y2)> f,
            double t, double dt, (Vector3D y1, Vector3D y2) y)
        {
            var (y1, y2) = y;
        ...
        public static ((Vector3D y1, Vector3D y2, Vector3D y3) y, (Vector3D e1, Vector3D e2, Vector3D e3) err) Step45(
            Func<double, (Vector3D y1, Vector3D y2, Vector3D y3), (Vector3D y1, Vector3D y2, Vector3D y3)> f,
            double t, double dt, (Vector3D y1, Vector3D y2, Vector3D y3) y)
        {
            var (y1, y2, y3) = y;
        ...
        public static (Vector3D[] Y, Vector3D[] Error) Step45(
            Func<double, IReadOnlyList<Vector3D>, Vector3D[]> f,
            double t, double dt, IReadOnlyList<Vector3D> y)
        {
            var m = y.Count;
            ...
            var k7 = f(t + dt, GetKY(yt = new Vector3D[yt.Length], y, v5, dt, m));
            var v4 = GetV(yt, m,
                (k1, 5179 / 57600d),
                (k3, 7571 / 16695d),
                (k4, 393 / 640d),
