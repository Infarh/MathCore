...
public static partial class SpecialFunctions
{
    ...
    public static class Bessel
    {
        ...
        private static void BesselAsymptote0(double x, out double P, out double Q)
        {
            var x2 = 64 / (x * x);
            var p2  = .0;
            p2 = 2485.271928957404011288128951 + x2 * p2;
            p2 = 153982.6532623911470917825993 + x2 * p2;
            p2 = 2016135.283049983642487182349 + x2 * p2;
            p2 = 8413041.456550439208464315611 + x2 * p2;
            p2 = 12332384.76817638145232406055 + x2 * p2;
            p2 = 5393485.083869438325262122897 + x2 * p2;
            var q2 = 1.0;
            q2 = 2615.700736920839685159081813 + x2 * q2;
            q2 = 156001.7276940030940592769933 + x2 * q2;
            q2 = 2025066.801570134013891035236 + x2 * q2;
            q2 = 8426449.050629797331554404810 + x2 * q2;
            q2 = 12338310.22786324960844856182 + x2 * q2;
            q2 = 5393485.083869438325560444960 + x2 * q2;
            var p3 = -.0;
            p3 = -4.887199395841261531199129300 + x2 * p3;
            p3 = -226.2630641933704113967255053 + x2 * p3;
            p3 = -2365.956170779108192723612816 + x2 * p3;
            p3 = -8239.066313485606568803548860 + x2 * p3;
            p3 = -10381.41698748464093880530341 + x2 * p3;
            p3 = -3984.617357595222463506790588 + x2 * p3;
            var q3 = 1.0;
            q3 = 408.7714673983499223402830260 + x2 * q3;
            q3 = 15704.89191515395519392882766 + x2 * q3;
            q3 = 156021.3206679291652539287109 + x2 * q3;
            q3 = 533291.3634216897168722255057 + x2 * q3;
            q3 = 666745.4239319826986004038103 + x2 * q3;
            q3 = 255015.5108860942382983170882 + x2 * q3;
            P  = p2 / q2;
            Q  = 8 * p3 / q3 / x;
        }
        ...
        private static void BesselAsymptote1(double x, out double P, out double Q)
        {
            ...
            p2 = -109824.0554345934672737413139 + x2 * p2;
            p2 = -1523529.351181137383255105722 + x2 * p2;
            p2 = -6603373.248364939109255245434 + x2 * p2;
            p2 = -9942246.505077641195658377899 + x2 * p2;
            p2 = -4435757.816794127857114720794 + x2 * p2;

            var q2 = 1.0;
            q2 = -1455.009440190496182453565068 + x2 * q2;
            q2 = -107263.8599110382011903063867 + x2 * q2;
            q2 = -1511809.506634160881644546358 + x2 * q2;
            q2 = -6585339.479723087072826915069 + x2 * q2;
            q2 = -9934124.389934585658967556309 + x2 * q2;
            q2 = -4435757.816794127856828016962 + x2 * q2;

            var p3 = 35.26513384663603218592175580;
            p3 = 1706.375429020768002061283546 + x2 * p3;
            p3 = 18494.26287322386679652009819 + x2 * p3;
            p3 = 66178.83658127083517939992166 + x2 * p3;
            p3 = 85145.16067533570196555001171 + x2 * p3;
            p3 = 33220.91340985722351859704442 + x2 * p3;

            var q3 = 1.0;
            q3 = 863.8367769604990967475517183 + x2 * q3;
            q3 = 37890.22974577220264142952256 + x2 * q3;
            q3 = 400294.4358226697511708610813 + x2 * q3;
            q3 = 1419460.669603720892855755253 + x2 * q3;
            q3 = 1819458.042243997298924553839 + x2 * q3;
            q3 = 708712.8194102874357377502472 + x2 * q3;
        ...
        public static double J0(double x)
        {
            ...
            p1 = -40504123.71833132706360663322 + x2 * p1;
            p1 = 25071582855.36881945555156435 + x2 * p1;
            p1 = -8085222034853.793871199468171 + x2 * p1;
            p1 = 1434354939140344.111664316553 + x2 * p1;
            p1 = -136762035308817138.6865416609 + x2 * p1;
            p1 = 6382059341072356562.289432465 + x2 * p1;
            p1 = -117915762910761053603.8440800 + x2 * p1;
            p1 = 493378725179413356181.6813446 + x2 * p1;

            var q1 = 1.0;
            q1 = 1363.063652328970604442810507 + x2 * q1;
            q1 = 1114636.098462985378182402543 + x2 * q1;
            q1 = 669998767.2982239671814028660 + x2 * q1;
            q1 = 312304311494.1213172572469442 + x2 * q1;
            q1 = 112775673967979.8507056031594 + x2 * q1;
            q1 = 30246356167094626.98627330784 + x2 * q1;
            q1 = 5428918384092285160.200195092 + x2 * q1;
            q1 = 493378725179413356211.3278438 + x2 * q1;
        ...
        public static double J1(double x)
        {
            ...
            p1 = -4695753.530642995859767162166 + x2 * p1;
            p1 = 3413234182.301700539091292655 + x2 * p1;
            p1 = -1322983480332.126453125473247 + x2 * p1;
            p1 = 290879526383477.5409737601689 + x2 * p1;
            p1 = -35888175699101060.50743641413 + x2 * p1;
            p1 = 2316433580634002297.931815435 + x2 * p1;
            p1 = -66721065689249162980.20941484 + x2 * p1;
            p1 = 581199354001606143928.050809 + x2 * p1;

            var q1 = 1.0;
            q1 = 1606.931573481487801970916749 + x2 * q1;
            q1 = 1501793.594998585505921097578 + x2 * q1;
            q1 = 1013863514.358673989967045588 + x2 * q1;
            q1 = 524371026216.7649715406728642 + x2 * q1;
            q1 = 208166122130760.7351240184229 + x2 * q1;
            q1 = 60920613989175217.46105196863 + x2 * q1;
            q1 = 11857707121903209998.37113348 + x2 * q1;
            q1 = 1162398708003212287858.529400 + x2 * q1;
        ...
        public static double Y0(double x)
        {
            ...
            p4 = 59152134.65686889654273830069 + x2 * p4;
            p4 = -34363712229.79040378171030138 + x2 * p4;
            p4 = 10255208596863.94284509167421 + x2 * p4;
            p4 = -1648605817185729.473122082537 + x2 * p4;
            p4 = 137562431639934407.8571335453 + x2 * p4;
            p4 = -5247065581112764941.297350814 + x2 * p4;
            p4 = 65874732757195549259.99402049 + x2 * p4;
            p4 = -27502866786291095837.01933175 + x2 * p4;

            var q4 = 1.0;
            q4 = 1282.452772478993804176329391 + x2 * q4;
            q4 = 1001702.641288906265666651753 + x2 * q4;
            q4 = 579512264.0700729537480087915 + x2 * q4;
            q4 = 261306575504.1081249568482092 + x2 * q4;
            q4 = 91620380340751.85262489147968 + x2 * q4;
            q4 = 23928830434997818.57439356652 + x2 * q4;
            q4 = 4192417043410839973.904769661 + x2 * q4;
            q4 = 372645883898616588198.9980 + x2 * q4;
        ...
        public static double Y1(double x)
        {
            ...
            p4 = 3639488548.124002058278999428 + x2 * p4;
            p4 = -2580681702194.450950541426399 + x2 * p4;
            p4 = 956993023992168.3481121552788 + x2 * p4;
            p4 = -196588746272214065.8820322248 + x2 * p4;
            p4 = 21931073399177975921.11427556 + x2 * p4;
            p4 = -1212297555414509577913.561535 + x2 * p4;
            p4 = 26554738314348543268942.48968 + x2 * p4;
            p4 = -99637534243069222259967.44354 + x2 * p4;

            var q4 = 1.0;
            q4 = 1612.361029677000859332072312 + x2 * q4;
            q4 = 1563282.754899580604737366452 + x2 * q4;
            q4 = 1128686837.169442121732366891 + x2 * q4;
            q4 = 646534088126.5275571961681500 + x2 * q4;
            q4 = 297663212564727.6729292742282 + x2 * q4;
            q4 = 108225825940881955.2553850180 + x2 * q4;
            q4 = 29549879358971486742.90758119 + x2 * q4;
            q4 = 5435310377188854170800.653097 + x2 * q4;
            q4 = 508206736694124324531442.4152 + x2 * q4;
