...
namespace MathCore.Tests.CommandProcessor
{
    ...
    public class CommandLineProcessorTests
    {
        ...
        private readonly List<(string, TimeSpan)> _Values = new List<(string, TimeSpan)>();
        ...
        public CommandLineProcessorTests()
        {
            ...
            console_out_mock
               ...
               .Callback((char[] Buffer, int Index, int Count) => _Values.Add((new string(Buffer), _Timer.Elapsed)));
        ...
        public void Test()
        {
            ...
            processor[__ExitCommandName] += (c, i, cc) => Work = false;
            processor[__HelpCommandName] += (c, i, cc) => processor.GetRegisteredCommands().Foreach(_Logger.WriteLine);
